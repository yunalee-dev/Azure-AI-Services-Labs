...
OUTPUT_PATH = BASE_DIR / "outputs" / "sentiment_results.json"
...
def analyze_sentiment() -> list[dict]:
    ...
    for doc, result in zip(documents, results):
        ...
        if result.is_error:
            ...
            item["document_sentiment"] = result.sentiment
